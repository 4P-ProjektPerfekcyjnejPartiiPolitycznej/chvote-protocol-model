...
/**
 * This model class contains all the data necessary to verify the validity of an election, including the tally.
 */
@SuppressWarnings("unused")
public final class ElectionVerificationDataWithTally extends ElectionVerificationData {
  private final Tally tally;

  @JsonCreator
  public ElectionVerificationDataWithTally(
      ...
      @JsonProperty("tally") Tally tally) {
