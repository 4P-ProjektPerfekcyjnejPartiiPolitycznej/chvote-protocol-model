 ...
 * This class also contains the signature to authenticate the election set's issuer.
 */
@SuppressWarnings("unused")
public final class SignedElectionSet {

  private final ElectionSetWithPublicKey electionSet;
  private final Signature                signature;

  @JsonCreator
  public SignedElectionSet(@JsonProperty("electionSet") ElectionSetWithPublicKey electionSet,
