...
public final class ShuffleProof {
  ...
  @JsonCreator
  public ShuffleProof(@JsonProperty("t") T t,
                      @JsonProperty("s") S s,
                      @JsonProperty("bold_c") List<BigInteger> bold_c,
                      @JsonProperty("bold_c_hat") List<BigInteger> bold_c_hat) {
    this.t = t;
    this.s = s;
  ...
  public static final class T implements Hashable {
    ...
    @JsonCreator
    public T(@JsonProperty("t_1") BigInteger t_1,
             @JsonProperty("t_2") BigInteger t_2,
             @JsonProperty("t_3") BigInteger t_3,
             @JsonProperty("t_4") List<BigInteger> t_4,
             @JsonProperty("t_hat") List<BigInteger> t_hat) {
      ...
      Preconditions.checkArgument(!t_hat.isEmpty());
      this.t_1 = t_1;
      this.t_2 = t_2;
      this.t_3 = t_3;
  ...
  public static final class S {
    ...
    @JsonCreator
    public S(@JsonProperty("s_1") BigInteger s_1,
             @JsonProperty("s_2") BigInteger s_2,
             @JsonProperty("s_3") BigInteger s_3,
             @JsonProperty("s_4") BigInteger s_4,
             @JsonProperty("s_hat") List<BigInteger> s_hat,
             @JsonProperty("s_prime") List<BigInteger> s_prime) {
      ...
      Preconditions.checkArgument(!s_hat.isEmpty());
